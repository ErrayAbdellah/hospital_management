...
<div id="signUpForm" class="container bg-muted text-dark w-50 p-1 d-block mx-auto ">
    ...
    <div class="form-group mx-5">
        <label for="adresse"  class="text-dark fw-bold p-2 ">Adresse :</label>
        <input name="adresse" type="text" class="form-control w-75"  placeholder="Enter Adresse">
        <small class="form-text text-muted"></small>
    </div>
    <div class="form-group mx-5">
        <label for="email"  class="text-dark fw-bold p-2 ">Email :</label>
        <input name="email" type="email" class="form-control w-75"  placeholder="Enter Email">
        <small class="form-text text-muted"></small>
    </div>
    <div class="form-group mx-5">
        <label for="CIN"  class="text-dark fw-bold p-2 ">CIN :</label>
        <input name="CIN" type="text" class="form-control w-75 "  placeholder="Enter CIN">
        <small class="form-text text-muted"></small>
    </div>
    <div class="form-group mx-5">
        <label for="Birth Day"  class="text-dark fw-bold p-2 ">Date Of Birth :</label>
        <input name="birthDate" type="date" class="form-control w-75"  placeholder="Enter Birth day">
        <small class="form-text text-muted"></small>
    </div>
    <div class="form-group mx-5">
        <label for="Pwd"  class="text-dark fw-bold p-2 ">Password :</label>
        <input name="pwd" type="password" class="form-control w-75"  placeholder="Password">
        <small class="form-text text-muted">jhghgjhghg</small>
    </div>
    <div class="form-group mx-5">
        <label for="ConfirmedPwd"  class="text-dark fw-bold p-2 ">Confirm Password :</label>
